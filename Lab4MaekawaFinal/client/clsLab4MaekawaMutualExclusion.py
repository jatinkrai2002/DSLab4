...
class clsLab4MaekawaMutualExclusion(iLab4MaekawaMutualExclusion):

    #static request send  for 3 process.
    P0RequetSendQueue = []
    P1RequetSendQueue = []
    P2RequetSendQueue = []

    #receive Queue for 3 process.
    P0recevieQueue = []
    P1recevieQueue = []
    P2recevieQueue = []

    #static Quorum for 3 process
    QuoromforP0 = []
    QuoromforP1 = []
    QuoromforP2 = []

    #processaarry for 3 process
    processarray = []

    # constructor
    def __init__(self, maekawa_manager, number_of_process):
        self.vector_clock = clsLab4VectorClock()
        self.process_id = 1 #hard coded
